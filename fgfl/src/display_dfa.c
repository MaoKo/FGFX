...
static inline void
display_dfa_typedef(int filde, size_t size_trans, size_t size_final) {
...
static void
display_token_enum(int filde, vector_t const* elst) {
...
void
display_state_table(int filde, vector_t const* trans, char const* header) {
...
void
display_final_table(int filde, vector_t const* final, char const* header) {
...
void
display_skip_table(int filde, vector_t const* elst, char const* header) {
...
static inline void
display_dfa_useful_macro(int filde) {
	dprintf(filde, DEFINE(START_STATE, 1) NL);
	dprintf(filde, DEFINE(DEAD_STATE, 0) NL NL);
}

int
display_dfa_matrix(char const* base_file, vector_t const* trans,
