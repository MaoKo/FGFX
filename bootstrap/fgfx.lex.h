...
fgfx_begin_table[TOTAL_TOKEN][TOTAL_STATE] = {
	...
	[T_CLOSE_REGEX][S_BEG_REGEX] = BEGIN(S_GLOBAL), [T_CLOSE_REGEX][S_BODY_REGEX] = BEGIN(S_GLOBAL), 
	[T_REG_UNION][S_BEG_REGEX] = BEGIN(S_BODY_REGEX), 
	...
	[T_REG_BOUND_NAME][S_BEG_REGEX] = BEGIN(S_BODY_REGEX), 
	[T_REG_LBRACE][S_BEG_REGEX] = BEGIN(S_FINITE_SEQ), [T_REG_LBRACE][S_BODY_REGEX] = BEGIN(S_FINITE_SEQ), 
	[T_REG_RBRACE][S_FINITE_SEQ] = BEGIN(S_BODY_REGEX), 
	[T_REG_LBRACK][S_BEG_REGEX] = BEGIN(S_BEG_CCL), [T_REG_LBRACK][S_BODY_REGEX] = BEGIN(S_BEG_CCL), 
